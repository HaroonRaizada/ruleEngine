...
public class TriggerRuleEngineTest {
	...
	//Rule for Main Class. If no input passed
	 @BeforeClass
	...
	public void executeRuleTestVideo() throws Exception {
		...
		TriggerRuleEngine.main(inputParams);
		Boolean isTrue = outContent.toString().contains("add a free “First Aid” video to the packing slip (the result of a court decision in 1997)");
